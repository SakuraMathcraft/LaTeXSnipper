...
from ui.edit_formula_dialog import EditFormulaDialog  # noqa: E402
from ui.favorites_window import FavoritesWindow  # noqa: E402
from ui.pdf_result_window import PdfResultWindow  # noqa: E402
from workers.recognition_workers import PdfPredictWorker, PredictionWorker  # noqa: E402
...
# WebEngine lazy import
QWebEngineView = None

def ensure_webengine_loaded() -> bool:
    """Delay-load WebEngine and cache QWebEngineView."""
    global QWebEngineView
    if QWebEngineView is not None:
        print("[DEBUG] WebEngine 已加载")
        return True
    QWebEngineView = load_webengine_view(APP_DIR)
...
class MainWindow(QMainWindow):
    ...
    def set_shortcut(self):
        ...
        lay.addWidget(QLabel(f"当前: {current_hotkey} 按下新的 {HOTKEY_HELP_TEXT}，或按 Esc 取消"))
        edit = QLineEdit(dlg)
