...
- **转为 OLE 公式：** 将选中的 OMML 管理公式转为 OLE 公式对象（支持更多渲染选项）
- **转为 Word OMML：** 将 OLE 公式转为 Word 原生 OMML 公式（可像 Word 公式一样直接编辑）
...
PowerPoint 不包含编号组、引用组、边界组、格式化组——这些是 Word 文档专属功能。
...
- **Word OMML：** 转换为 Word 原生 OMML 公式，可直接在 Word 中编辑
