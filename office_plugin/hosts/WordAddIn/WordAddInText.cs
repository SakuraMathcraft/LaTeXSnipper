...
public static class WordAddInText
{
    ...
    private static string GetEn(string key)
    {
        return key switch
        {
            ...
            "InsertNumberedTip" => "Insert an automatically numbered display equation.",
            ...
            "InsertInsideNumberedFormulaError" => "Place the cursor outside the numbered formula before inserting another formula.",
    ...
    private static string GetZh(string key)
    {
        return key switch
        {
            ...
            "InsertInsideNumberedFormulaError" => "请将光标移到带编号的公式外，再插入其他公式。",
            "TaskPaneTitle" => "LaTeXSnipper",
            "TaskPaneActions" => "操作",
            "ReadyStatus" => "就绪。",
            "WorkingStatus" => "处理中...",
