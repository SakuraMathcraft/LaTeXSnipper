#!/bin/bash
# Build an offline Debian/Ubuntu .deb package with bundled MathCraft models.
#
# Usage:
...
DEB_PATH="$DEB_OUTPUT_DIR/latexsnipper-offline_${VERSION}_amd64.deb"
...
chmod 755 "$MAIN_BIN"
write_debian_launcher "$PACKAGE_ROOT" "/usr/lib/latexsnipper-offline/LaTeXSnipperOffline"
