...
const TEXT = {
  "en-US": {
    ...
    connectedBridge: "Connected to local LaTeXSnipper bridge ({feature}).",
    ocrEnabled: "OCR enabled",
    conversionOnly: "conversion only",
    startBridge: "Start LaTeXSnipper Office bridge to auto-configure the add-in.",
    connectedProtocol: "Connected to {name}, protocol {protocol}.",
    conversionRequired: "Connected bridge does not support LaTeX conversion.",
    ...
    ocrLoaded: "Screenshot OCR result loaded.",
  ...
  "zh-CN": {
    ...
    connectedBridge: "已连接本机 LaTeXSnipper Bridge（{feature}）。",
    ocrEnabled: "可用截图识别",
    conversionOnly: "仅可转换",
    startBridge: "请启动 LaTeXSnipper Office Bridge 以自动配置加载项。",
    connectedProtocol: "已连接 {name}，协议版本 {protocol}。",
    conversionRequired: "已连接的 Bridge 不支持 LaTeX 转换。",
...
const ERROR_TRANSLATIONS: Record<string, string> = {
  ...
  "Connected bridge does not support Screenshot OCR. Enable the Office bridge in LaTeXSnipper.": "当前 Bridge 不支持截图识别，请在 LaTeXSnipper 中启用 Office Bridge。",
